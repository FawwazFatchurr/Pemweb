...
<head>
    ...
    <link rel="stylesheet" href="../css/admin-equip.css">
...
<div class="main">
    <div class="equip-container">
        <div class="equip-judul">
            <h3>EQUIPMENT</h3>
        </div>
        <div class="equip-content">
            <form action="" method="post" class="form-equip">
            <a href="admin-equip-editw.php" class="equip-item">
                <div >
                    <h3>WEAPON</h3>
                </div>
            </a>
            <a href="admin-equip-edits.php" class="equip-item">
                <div >
                    <h3>SHIELD</h3>
                </div>
            </a>
            <a href="admin-equip-edita.php" class="equip-item">
                <div >
                    <h3>ARMOUR</h3>
                </div>
            </a>
