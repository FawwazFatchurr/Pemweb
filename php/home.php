...
<div class="container">
    ...
    <div class="bg-vd-con">
        ...
        <div class="bg-vd">
            <div class="bg-text">
                <h1>Build Your Best <br>Character</h1>
...
<!--            <video src="../img/bg-homee.mp4" autoplay muted loop></video>-->
        </div>

        <div class="bg-img1">
            <img src="../img/elden-ring-launch-trailer-thumbnail (1).jpg" alt="">
        </div>
    ...
    <div class="content">
        ...
        <section class="opening">
            <div class="elden-ring-judul">
                <img src="../img/text-elden.webp" alt="Elden Ring">
            ...
            <div class="fitur-con">
                ...
                <div class="maps">
                    ...
                    <div class="maps-right">
                        <div class="maps-judul">
                            <h3>INTERRACTIVE MAPS</h3>
                        </div>
                        <div class="maps-ket">
                            <p>Our website offers interactive maps designed to enhance your Elden Ring experience, allowing you to easily explore the vast, 
                                intricate world of the game. With these interactive tools, you can effortlessly navigate the expansive landscapes of the Lands Between. <br><br>

                                These maps provide detailed views of each region, helping you uncover the hidden secrets and key locations within the game. 
                                You can zoom in on specific areas, track your progress, and find everything from hidden dungeons to important landmarks. 
                                Whether you’re looking for the next boss fight, an NPC questline, or an elusive collectible, the interactive nature of our maps 
                                ensures you have everything you need to enhance your journey through Elden Ring. <br><br>
                                
                                Explore, uncover secrets, and enrich your Elden Ring adventure with our interactive maps!.</p>
                        </div>
                    </div>
                    ...
                    <div class="char-container">
                        <div class="char-slider">
                            ...
                            <div class="button">
                                ...
                                <a href="#"><div class="kanan">SHOW DETAILS</div></a>
                            </div>    
